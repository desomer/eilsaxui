...
public class CssTransition extends XHTMLPart {
	...
	public Element xStyle() {
		...
		return xCss()			
				...
				.on(".activity.circleAnim0prt", "z-index:1; clip-path:circle(0.0% at 85vw 90vh); -webkit-clip-path:circle(0.0% at 85vw 90vh); ")
				...
				.on(".activity.transitionSpeedSlow", "transition:all "+ CssTransition.SPEED_SHOW_ACTIVITY*1.5 +"ms linear")
